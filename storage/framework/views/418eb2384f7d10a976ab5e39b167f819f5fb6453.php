    ...
    <?php if(class_exists($options->model)): ?>
        ...
        <?php if($options->type == 'belongsTo'): ?>
            ...
            <?php else: ?>
                ...
                <select
                    class="form-control select2-ajax" name="<?php echo e($relationshipField); ?>"
...
<?php endif; ?>
<?php /**PATH /var/www/vhosts/vps-theschool.host4g.ru/dev.theschool.ru/life/vendor/tcg/voyager/src/../resources/views/formfields/relationship.blade.php ENDPATH**/ ?>