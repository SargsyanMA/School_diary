                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6">
                                    <strong><?php echo e($item->date ? $item->date->format('d.m.Y') : ''); ?></strong>
                                    <small class="text-muted"><?php echo e($item->date ? $item->date->format('H:i') : ''); ?></small>
                                    <p>
                        ...
                        <form id="event-add">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <div class="btn-group" data-toggle="buttons">
                                        <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($grade->number <=4 ): ?>
                                                <label class="btn btn-primary btn-xs btn-outline ">
                                                    <input name="grade[]" type="checkbox" autocomplete="off" value="<?php echo e($grade->id); ?>"><?php echo e($grade->number); ?><?php echo e($grade->letter); ?>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="btn-group" data-toggle="buttons">
                                        <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($grade->number >=5 && $grade->number <=9): ?>
                                                <label class="btn btn-primary btn-xs btn-outline">
                                                    <input name="grade[]" type="checkbox" autocomplete="off" value="<?php echo e($grade->id); ?>"><?php echo e($grade->number); ?><?php echo e($grade->letter); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/vps-theschool.host4g.ru/dev.theschool.ru/life/resources/views/events.blade.php ENDPATH**/ ?>