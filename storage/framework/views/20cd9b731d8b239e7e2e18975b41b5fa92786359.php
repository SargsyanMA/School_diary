                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="<?php echo e(__('voyager::generic.email')); ?>"
                                       value="<?php echo e($dataTypeContent->email ?? ''); ?>">
                            </div>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /* /var/www/vhosts/vps-theschool.host4g.ru/dev.theschool.ru/life/vendor/tcg/voyager/src/../resources/views/users/edit-add.blade.php */ ?>