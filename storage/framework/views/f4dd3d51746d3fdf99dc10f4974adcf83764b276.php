        ...
        <form class="row js-filter-form" method="get">
            <?php $__currentLoopData = $filter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="form-group col-md-2">
                    ...
                    <?php if($item['type'] === 'select'): ?>
                        <select class="form-control input-sm js-filter-select" name="<?php echo e($name); ?>">
                    ...
                    <?php elseif($item['type'] === 'date-range'): ?>
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" class="form-control datetimepicker" name="<?php echo e($name); ?>[]" value="<?php echo e(Carbon\Carbon::parse($item['value'][0])->format('d.m.Y')); ?>">
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control datetimepicker" name="<?php echo e($name); ?>[]" value="<?php echo e(Carbon\Carbon::parse($item['value'][1])->format('d.m.Y')); ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="clearfix"></div>
                ...
                <div class="form-group col-md-3 pull-right text-right" style="padding-top: 18px;">
                    <a href="<?php echo e(url('/score/index/print?').http_build_query(request()->query())); ?>" target="_blank" class="btn btn-info"><i class="fa fa-print"></i></a>
                </div>
        </form>
    </div>

    <div class="row">
        <?php echo $__env->make('includes.mass-scores', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>

    <div class="scores" style="position:relative; margin-bottom: 20px;">
        <div id="table-scroll" class="table-scroll">
            <div class="table-wrap">
                <?php echo $__env->make('score.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>

    <a class="btn btn-info btn-sm btn-outline" href="/calendar?mode=teacher&teacher=<?php echo e($filter['teacher_id']['value']); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/vps-theschool.host4g.ru/dev.theschool.ru/life/resources/views/score/index.blade.php ENDPATH**/ ?>