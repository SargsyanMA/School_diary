        ...
        <form action="" method="post" class="form-inline lesson-add hidden">
            ...
            <div class="form-group">
                <select name="type" class="form-control">
                    <option value="general">Основное образование</option>
                    <option value="additional">Дополнительное образование</option>
                    <option value="individual">Индивидуальные занятия</option>
                    <option value="psylog">Психолог/логопед</option>
                    <option value="childgarden">Детский сад</option>
                    <option value="zhome">Уход домой</option>
                </select>
            </div>
            ...
            <table class="table table-condensed lessons">
                ...
                <?foreach($lessons as $lesson):?>
                    <tr id="lesson-<?=$lesson['id'];?>">
                        ...
                        <td class="lesson-type" data-lesson-type="<?=$lesson['type'];?>"><?=Lesson::getInstance()->getTypeNameByCode($lesson['type']);?></td>
                        <td class="edit-buttons">
                            <a href="#edit" class="btn btn-xs btn-outline btn-warning lesson-edit" data-lesson-id="<?=$lesson['id'];?>"><i class="fa fa-pencil"></i></a>
