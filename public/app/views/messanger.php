        ...
        <div class="ibox chat-view">
            ...
            <div class="ibox-content">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <button id="sendMessage" class="btn btn-success btn-sm"><i class="fa fa-paper-plane" aria-hidden="true"></i> Отправить</button>
                ...
                <?if($currentUserGroup==4 || $currentUserGroup==1):?>
                    <div class="row">
                        <div class="col-lg-12">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" data-dismiss="modal" id="sendMessages"><i class="fa fa-paper-plane" aria-hidden="true"></i> Отправить</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<script>
    ...
    $(function() {
        var lastId= 0, openGroups=[], selectedContact=parseInt(parseUrlQuery()['userid']);
        ...
        function loadContacts(callback) {
            ...
            $.getJSON('/controllers/messenger.php', data, function (response) {
            ...
            if (to > 0) {
                ...
                $.getJSON('/controllers/messenger.php', data, function (response) {
                    ...
                    if (response.lastId>lastId || lastId==0 ) {
                        ...
                        $.getJSON('/controllers/messenger.php', dataView, function (response) {});
        ...
        function uploadFiles(callback) {
            ...
            $.ajax({
                url: '/controllers/messenger.php?action=uploadFile',
                type: 'POST',
                data: data,
                cache: false,
                dataType: 'json',
