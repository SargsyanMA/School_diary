    ...
    <div class="col-md-6">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <?if($access=='root' || ($access=='edit' && $currentUser['class'])):?>
                    <div class="row">
                        <form id="event-add">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <div class="btn-group" data-toggle="buttons">
                                        <?foreach($grades as $grade): if ($grade['number']<=4):?>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="btn-group" data-toggle="buttons">
                                        <?foreach($grades as $grade):if ($grade['number']>=5 && $grade['number']<=9):?>
                                            <label class="btn btn-primary btn-xs btn-outline">
                                                <input name="grade[]" type="checkbox" autocomplete="off" value="<?=$grade['id'];?>"><?=$grade['number'];?><?=$grade['letter'];?>
                                            </label>
                                        <?endif; endforeach;?>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="btn-group" data-toggle="buttons">
                                        <?foreach($grades as $grade):if ($grade['number']>=10):?>
                                            <label class="btn btn-primary btn-xs btn-outline ">
                                                <input name="grade[]" type="checkbox" autocomplete="off" value="<?=$grade['id'];?>"><?=$grade['number'];?><?=$grade['letter'];?>
                                            </label>
                                        <?endif; endforeach;?>
    ...
    $(function() {
        ...
        $( "#event-add" ).submit(function( event ) {
            ...
            if (formData.date=='') {
                ...
                $.post('/controllers/event.php?action=setEvent', $(this).serialize(), function() {
        ...
        $.getJSON('/controllers/holiday.php', data, function (data) {
            ...
            $('#calendar').fullCalendar({
                ...
                dayRender: function (date, cell) {
                    ...
                    for(key in holidays) {
                        console.log(holidays[key].contains(date));
