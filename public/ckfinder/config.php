...
$config['licenseName'] = 'life.school-lichnost.ru';
//$config['licenseName'] = 'school';
...
if (!file_exists($_SERVER['DOCUMENT_ROOT'].'/upload/user/'.\Illuminate\Support\Facades\Auth::user()->id.'/files')) {
    mkdir($_SERVER['DOCUMENT_ROOT'] . '/upload/user/' . \Illuminate\Support\Facades\Auth::user()->id . '/files', 0777, true);
}

$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/upload/user/'.\Illuminate\Support\Facades\Auth::user()->id.'/',
    'chmodFiles'   => 0777,
    'chmodFolders' => 0777,
...
$config['backends'][] = array(
    ...
    'adapter'      => 'database',
    'dsn'          => 'mysql:host=127.0.0.1;dbname=life',
    'tableName'    => 'files',
    'username'     => 'life',
    'password'     => 'i4Vy2_m2'
);
...
$config['resourceTypes'][] = array(
    'name'              => 'FilesDb', // Single quotes not allowed.
    'label'             => 'Мои файлы',
    'directory'         => 'files',
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,webm',
    'deniedExtensions'  => '',
