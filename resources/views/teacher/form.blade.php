                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal user-edit" action="{{ $action }}">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Должность</label>
                                <div class="col-sm-10"><input type="text" class="form-control" name="position"  value="{{$student->position ?? old('position') }}"></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label">Куратор</label>
                                <div class="col-sm-10">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="curator" {{ isset($student->curator)
                                            ? ($student->curator ? 'checked' : '')
                                            : (!empty(old('curator'))? 'checked' : '') }}
                                            value="1">
                                        </label>
                                    </div>
                                </div>
