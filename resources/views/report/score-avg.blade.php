...
@section('content')
        ...
        <div class="filter">
            <form method="get" class="row">
                ...
                <div class="form-group col-md-3 pull-right text-right" style="padding-top: 18px;">
                    <a href="{{url('/reports/score-avg/print?').http_build_query(request()->query())}}" target="_blank" class="btn btn-info"><i class="fa fa-print"></i></a>
                    <a href="{{url('/reports/score-avg-export?').http_build_query(request()->query())}}" target="_blank" class="btn btn-info"><i class="far fa-file-excel"></i></a>
                </div>
            </form>
        </div>
    @endif
    ...
    <div style="overflow-x: scroll">
        @include('report.score-avg-table', [
            'users' => $users,
