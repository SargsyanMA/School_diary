                    ...
                    <div class="ibox-content">
                        ...
                        <form class="m-t" role="form" method="post" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Имя пользователя" name="email" id="login" required autofocus autocomplete="on" value="{{ old('email') }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label for="remember-me" >
                                    <input type="checkbox" class="checkbox" name="remember" value="1" id="remember" {{ old('remember') ? 'checked' : '' }} /> Запомнить меня на этом устройстве
                                </label>
                            </div>
